package com.practicaltest.brighterbrain.progressactivity;
...
public class ProgressActivity extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        emptyStateImageWidth =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_progressEmptyStateImageWidth, 150);

        emptyStateImageHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_progressEmptyStateImageHeight, 150);

        emptyStateTitleTextSize =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_progressEmptyStateTitleTextSize, 16);
        ...
        errorStateImageWidth =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_progressErrorStateImageWidth, 150);

        errorStateImageHeight =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_progressErrorStateImageHeight, 150);

        errorStateTitleTextSize =
                typedArray.getDimensionPixelSize(R.styleable.ProgressActivity_progressErrorStateTitleTextSize, 16);
    ...
    private void setEmptyView() {
        view = inflater.inflate(R.layout.progress_loading_view, null);
        emptyStateRelativeLayout = (RelativeLayout) view.findViewById(R.id.loadingStateRelativeLayout);
